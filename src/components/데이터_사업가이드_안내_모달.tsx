              ...
              <div className="space-y-4">
                ...
                <div className="p-5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30 space-y-2">
                  ...
                  <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
                    • <strong>응급취약지:</strong> 권역/지역응급센터 60분 미도달 인구비율 30% 이상 또는 관내이용률(RI) 30% 미만.<br />
                    • <strong>분만취약지:</strong> 관내 분만율 40% 미만 또는 60분 미도달 30% 이상 (A등급 연 5억, B등급 연 2억 지원).<br />
                    • <strong>소아취약지:</strong> 필요 병상 대비 60% 미만 공급 지역 국비 50% 우선 지원 및 달빛어린이병원(야간 23시/휴일 18시) 지정.
                  </p>
                </div>
