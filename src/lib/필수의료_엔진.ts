...
export const 취약도_등급_정보: Record<취약도_등급, 취약도_메타정보> = {
  정상: {
    ...
    라벨: '정상 (Safe)',
    색상코드: '#22c55e',
    배경색상_클래스: 'bg-emerald-100 text-emerald-800 border-emerald-300',
    텍스트색상_클래스: 'text-emerald-600',
  ...
  관찰: {
    ...
    라벨: '관찰 (Caution)',
    색상코드: '#eab308',
    배경색상_클래스: 'bg-amber-100 text-amber-800 border-amber-300',
    텍스트색상_클래스: 'text-amber-600',
  ...
  취약: {
    ...
    라벨: '취약 (Vulnerable)',
    색상코드: '#f97316',
    배경색상_클래스: 'bg-orange-100 text-orange-800 border-orange-300',
    텍스트색상_클래스: 'text-orange-600',
  ...
  심각: {
    ...
    라벨: '심각 (Critical)',
    색상코드: '#ef4444',
    배경색상_클래스: 'bg-rose-100 text-rose-800 border-rose-300',
    텍스트색상_클래스: 'text-rose-600',
