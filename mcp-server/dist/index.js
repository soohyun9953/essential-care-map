        ...
        tools: [
            {
                ...
                description: '국립중앙의료원 중앙응급의료센터 API 연계: 특정 지자체(시군구)의 실시간 응급실 가용병상, 음압병상, 중환자실, 소아병상 및 CT/MRI 장비 가동 현황을 조회합니다.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sgg: {
            ...
            },
            {
                ...
                description: '건강보험심사평가원(HIRA) 의료자원 통계 연계: 해당 지자체의 의사인력(산부인과/소아청소년과/응급의학과 전문의 수), 분만실 인가병상, 소아전용 병상 등 필수의료 인프라 통계를 조회합니다.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sgg: {
            ...
            },
            {
                ...
                description: '보건복지부 지정 달빛어린이병원 및 심야/휴일 소아진료기관 현황을 조회하여 야간 소아의료 공백 여부를 파악합니다.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sgg: {
            ...
            },
            {
                ...
                description: '보건복지부 취약지 고시 기준 3대 필수의료(응급·분만·소아) 종합 취약도 진단 및 4단계 등급(심각/취약/관찰/정상)을 판정합니다.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sgg: {
            ...
            },
            {
                ...
                description: '국립중앙의료원 및 보건복지부 공모신청 표준 서식에 맞춘 공문서 개조식 사업계획서 서술문을 실시간 통계 기반으로 자동 생성합니다.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        sgg: {
