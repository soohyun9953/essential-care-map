...
const CITATION_PAIRS: 대조_문장_매핑[] = [
  {
    id: 1,
    ai_text:
      '영월군의 응급의료센터 60분 내 미도달 인구 비율(플랫폼 내장 데이터 68.2%)은 응급의료취약지 선정 기준(30% 이상)에 해당하는 수준임.',
  ...
  },
  {
    id: 2,
    ai_text:
      '관내 분만율(플랫폼 지표 15.2%)이 낮아 분만 의료 접근성 개선이 필요함. 다만 분만취약지 선정 기준은 60분 내 분만의료 이용률과 접근 불가 인구비율로 별도 판단해야 함.',
  ...
  },
  {
    id: 3,
    ai_text:
      '기준 병상 대비 소아전용 병상 공급비율(플랫폼 지표 22.5%)이 플랫폼 진단 기준(60%)에 미달함.',
